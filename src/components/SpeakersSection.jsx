      ...
      <div className="container px-6 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 mt-12">
          ...
          >
            ...
            <p className="text-sm text-white mt-1 text-center">Apple</p>
          </div> */}
          ...
          >
            <Image
              src={Bodhisattwa}
              alt="Mr. Bodhisattwa Sanghapriya"
              width={128}
              height={128}
              className="w-32 h-32 rounded-full object-cover object-top ring-4 ring-gray-300"
            />
            ...
            <p className="mt-1 text-sm font-medium text-white text-center">
              Founder & CEO - IG Drones
            </p>

            <p className="text-sm text-white mt-1 text-center">Delhi, India</p>
          </div>
        </div>
      </div>
    </section>
